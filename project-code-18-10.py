# -*- coding: utf-8 -*-
"""
Created on Tue Oct 18 11:17:18 2022
...
hist_promt_p1_M = ROOT.TH1D("hist_p1_M_promt", "Pion 1 Mass", 50, 0, 600)
hist_promt_c2_M = ROOT.TH1D("hist_c2_M_promt", "", 50, 1700, 2000)
hist_promt_k3_M = ROOT.TH1D("hist_k3_M_promt", "Kaon Mass", 50, 0, 700)
hist_promt_p4_M = ROOT.TH1D("hist_p4_M_promt", "Pion 4 Mass", 50, 0, 300)
hist_promt_p5_M = ROOT.TH1D("hist_p5_M_promt", "Pion 5 Mass", 50, 0, 300)
hist_promt_p1_M_cut = ROOT.TH1D("hist_p1_M_promt_cut", "Pion 1 Mass", 50, 0, 600)
hist_promt_c2_M_cut = ROOT.TH1D("hist_c2_M_promt_cut", "", 50, 1700, 2000)
hist_promt_k3_M_cut = ROOT.TH1D("hist_k3_M_promt_cut", "Kaon Mass", 50, 0, 700)
hist_promt_p4_M_cut = ROOT.TH1D("hist_p4_M_promt_cut", "Pion 4 Mass", 50, 0, 300)
hist_promt_p5_M_cut = ROOT.TH1D("hist_p5_M_promt_cut", "Pion 5 Mass", 50, 0, 300)
...
hist_sig_p1_M = ROOT.TH1D("hist_p1_M_sig", "Pion 1 Mass", 50, 0, 600)
hist_sig_c2_M = ROOT.TH1D("hist_c2_M_sig", "", 50, 1700, 2000)
hist_sig_k3_M = ROOT.TH1D("hist_k3_M_sig", "Kaon Mass", 50, 0, 700)
hist_sig_p4_M = ROOT.TH1D("hist_p4_M_sig", "Pion 4 Mass", 50, 0, 300)
hist_sig_p5_M = ROOT.TH1D("hist_p5_M_sig", "Pion 5 Mass", 50, 0, 300)
hist_sig_p1_M_cut = ROOT.TH1D("hist_p1_M_sig_cut", "Pion 1 Mass", 50, 0, 600)
hist_sig_c2_M_cut = ROOT.TH1D("hist_c2_M_sig_cut", "", 50, 1700, 2000)
hist_sig_k3_M_cut = ROOT.TH1D("hist_k3_M_sig_cut", "Kaon Mass", 50, 0, 700)
hist_sig_p4_M_cut = ROOT.TH1D("hist_p4_M_sig_cut", "Pion 4 Mass", 50, 0, 300)
hist_sig_p5_M_cut = ROOT.TH1D("hist_p5_M_sig_cut", "Pion 5 Mass", 50, 0, 300)
